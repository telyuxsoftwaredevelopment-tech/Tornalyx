 ...
 *
 * Carga una plantilla PHP desde app/views, le inyecta los datos que le pasa el
 * controlador y devuelve (o imprime) el HTML resultante. Aísla el scope de la
 * plantilla para que solo vea las variables que el controlador decidió pasarle.
 */
...
class View {
     ...
     *
     * @param string $view Ruta relativa sin extensión, p. ej. 'publico/index'.
     ...
     * evitando el path traversal (no se permite salir de app/views).
     */
