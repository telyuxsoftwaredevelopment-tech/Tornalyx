...
| 8 | Modelos alineados al modelo relacional | ✅ | `SGDM/backend/models/*.php` (13 archivos) | 12 modelos de tablas de negocio heredan de `Model.php` (la base); tablas de unión simples (`sesiones`, `avisos_leidos`, `asistencias`) se manejan directamente desde el modelo relacionado. |
