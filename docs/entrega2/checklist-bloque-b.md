...
| 4 | Sistema de monitoreo listo para implementar en el servidor | ✅ | `scripts/servidor/instalar-monitoreo.sh`, `scripts/servidor/prometheus.yml`, `docs/entrega2/monitoreo.md` |
